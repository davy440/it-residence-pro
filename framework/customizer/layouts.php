...
function itre_sidebr_customize_register( $wp_customize ) {
    ...
    $wp_customize->add_control(
	    'itre-blog-excerpt-length', array(
		    'label'		=>	__('Excerpt Length (Classic & List)', 'it-residence'),
		    //'description'	=>	__('This works for Clasic and List Layouts to show Blog, Archives, and Search page', 'it-residence'),
		    'type'		=>	'number',
