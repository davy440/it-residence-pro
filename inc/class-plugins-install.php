...
class ITRE_Plugin_Upgrader {
    ...
    public function itre_enqueue_upgrader_script() {
        wp_enqueue_script('itre-plugins-install-js', esc_url( get_template_directory_uri() . '/assets/js/plugins-install.js' ), array(), ITRE_VERSION, true );
        $data = array(
    ...
    private static function itre_external_urls( $slug ) {
        $external = [
            'it-listings-pro'   =>  [
                'download_link' =>  'https://storage.googleapis.com/it-listings-pro/it-listings-pro.zip',
                'basename'      =>  'it-listings-pro/it-listings-pro.php',
